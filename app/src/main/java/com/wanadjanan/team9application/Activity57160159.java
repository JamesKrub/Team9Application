...
public class Activity57160159 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_57160159);
        Test = (TextView)findViewById(R.id.test);
        // Dropdown List
        Year = (Spinner) findViewById(R.id.Year57160159);
        createAnnoDomini();
        ...
        // Start Chart
        mybarchart = (BarChart)findViewById(R.id.Chart57160159);
        ...
        Year.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Spinner value = (Spinner) findViewById(R.id.Year57160159);
                String text = value.getSelectedItem().toString();
                Test.setText("งบประมาณใช้ไปจำแนกตามพันธกิจ ประจำปีงบประมาณ " + text);
                service.sendData0159(text).enqueue(new Callback<work57160159>() {
                    @Override
                    public void onResponse(Call<work57160159> call, Response<work57160159> response) {
                    ...
                    @Override
                    public void onFailure(Call<work57160159> call, Throwable t) {
                        Log.d("RESPONSE","service error");
                    }
                });
            }
