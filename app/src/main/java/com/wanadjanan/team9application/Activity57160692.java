...
public class Activity57160692 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_57160692);

        chart = (PieChart) findViewById(R.id.Chart57160692);
        txtbox = (TextView) findViewById(R.id.txt1);
        dropdown = (Spinner) findViewById(R.id.Year57160692);
        ...
        dropdown.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                service.sendData0692(year).enqueue(new Callback<work57160692>() {
                    @Override
                    public void onResponse(Call<work57160692> call, Response<work57160692> response) {
                        Log.d("Eiei","Success");
                        ...
                        txtbox.setText("งบประมาณใช้ไปจำแนกตามหน่วยงานที่รับผิดชอบ ประจำปีงบประมาณ "+ year);
                        chart.notifyDataSetChanged();
                        chart.invalidate();
                    }

                    @Override
                    public void onFailure(Call<work57160692> call, Throwable t) {
                        Log.d("Eiei","Sad");
                    }
                });
            }
