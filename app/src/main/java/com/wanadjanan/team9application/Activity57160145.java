...
public class Activity57160145 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_57160145);

        chart = (PieChart) findViewById(R.id.Chart57160145);
        txtbox = (TextView) findViewById(R.id.txt1);
        dropdown = (Spinner) findViewById(R.id.Year57160145);
        ...
        dropdown.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                service.sendData0145(year).enqueue(new Callback<work57160145>() {
                    @Override
                    public void onResponse(Call<work57160145> call, Response<work57160145> response) {
                        Log.d("Eiei","Success");
                        ...
                        txtbox.setText("จงบประมาณจัดสรรจำแนกตามหน่วยงานที่รับผิดชอบ ประจำปีงบประมาณ "+year);
                        chart.notifyDataSetChanged();
                        chart.invalidate();
                    }

                    @Override
                    public void onFailure(Call<work57160145> call, Throwable t) {
                        Log.d("Eiei","Sad");
                    }
                });
            }
